...
class Retriever:
    ...
    def search(self, query):
        ...
        # Debug: Print raw search results from vector DB
        print("\nRaw search results from vector DB:")
        for r in result:
            print("\nScore:", r.score)
        ...
        for entry in context[:3]:
            ...
            # Debug: Print each context entry
            print("\nProcessing context entry:")
            print(context)
            combined_prompt.append(context)

        final_output = "\n\n---\n\n".join(combined_prompt)
        # Debug: Print final formatted output
